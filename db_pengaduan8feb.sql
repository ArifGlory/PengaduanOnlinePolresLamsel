...
CREATE TABLE `tb_admin` (
  ...
  `hak_akses` enum('S','A','SR','KSR','SPKT') DEFAULT 'SPKT',
...
insert  into `tb_admin`(`id_admin`,`nama`,`email`,`password`,`hak_akses`,`status`) values (1,'Super Admin','super@gmail.com','123','S','T'),(4,'Amelia','amelia@gmail.com','123','SR','T'),(5,'Aguilar','aguilar@gmail.com','123','KSR','T'),(6,'Jack','jack@gmail.com','123','SPKT','T');
...
insert  into `tb_pengaduan`(`id_pengaduan`,`nama_pengaduan`,`kode_pengaduan`,`id_kejahatan`,`id_user`,`tempat_kejadian`,`tanggal`,`pukul`,`isKorban`,`orang_dilaporkan`,`deskripsi`,`status`) values (1,'Pencurian tas','JS7385',1,1,'Kalianda','2019-01-23','14:05','Y',NULL,'Ketika saya ketiduran di masjid, tas saya sudah hilang','P');
...
CREATE TABLE `tb_tanggapan` (
  ...
  `id_pengaduan` int(11) DEFAULT NULL,
  `isi_tanggapan` text,
  `publish` enum('M','P','T','S') DEFAULT NULL,
  PRIMARY KEY (`id_tanggapan`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `tb_tanggapan` */

insert  into `tb_tanggapan`(`id_tanggapan`,`id_pengaduan`,`isi_tanggapan`,`publish`) values (1,1,'siap kami Proses','P');
