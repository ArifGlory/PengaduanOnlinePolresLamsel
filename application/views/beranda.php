...
Copyright &copy; POLRES Lampung Selatan <script>document.write(new Date().getFullYear());</script> All rights reserved
		...
		<div id="colorlib-main">
			<aside id="colorlib-hero" class="js-fullheight">
				<div class="flexslider js-fullheight">
					<ul class="slides">
				   	<li style="background-image: url(<?php echo base_url();?>/foto/indopolice1.jpg);">
				   			...
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					<div class="desc">
						   					<h1>Kepolisian Resor Lampung Selatan</h1>
						   					<h2>Melindungi , Mengayomi , dan Melayani Masyarakat</a></h2>
											</div>
					   				</div>
					   			</div>
					   		</div>
				   	...
				   	<li style="background-image: url(<?php echo base_url();?>/foto/indopolice2.jpg);">
				   		<div class="overlay"></div>
				   		<div class="container-fluid">
				   			<div class="row">
					   			<div class="col-md-6 col-md-offset-3 col-md-push-3 col-sm-12 col-xs-12 js-fullheight slider-text">
					   				<div class="slider-text-inner">
					   					<div class="desc">
						   					<h1>Kami siap menerima pengaduan anda</h1>
												<h2>Obyektif Dipercaya Partisipasi</h2>
											</div>
					   				</div>
					   			</div>
					   		</div>
		...
		<!--	<div class="colorlib-about">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6">
							<div class="about-img animate-box" data-animate-effect="fadeInLeft" style="background-image: url(<?php /*echo base_url();*/?>/foto/pic4.jpeg);">
							</div>
						</div>
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<div class="about-desc">
                                ...
                                <h3>PT. Kapur Putih Lampung</h3>
								<p>We are a company engaged in mining limestone and processing of Cretaceous Agriculture (Kaptan) CaCO3 located in Cilutung Village, Negeri Katon District, Pesawaran Regency, Lampung.</p>
								<p>PT. KAPUR PUTIH LAMPUNG was originally a PT. Pola Marmer Kencana which was established in 1984. Then in 2013 the name changed to PT. Kapur Putih Lampung.</p>
							</div>
			...
			<div id="get-in-touch" class="colorlib-bg-color">
				<div class="colorlib-narrow-content">
					<div class="row">
						<div class="col-md-6 animate-box" data-animate-effect="fadeInLeft">
							<h2>Mulai Pengaduan disini !</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 col-md-offset-3 col-md-pull-3 animate-box" data-animate-effect="fadeInLeft">
							<p><a href="<?php echo base_url();?>Utama/pengaduan" class="btn btn-primary btn-learn">Pengaduan</a></p>
                            <p><a href="<?php echo base_url();?>Utama/cekPengaduan" class="btn btn-primary btn-learn">Cek Progres Pengaduan</a></p>
						</div>
